...
export async function createQRCodeRecord({ title, destination, active = true, id: fixedId, fixedUrl, ownerId, style, size }) {
...
export async function updateQRCodeRecord(docId, { title, destination, active, ownerId, style, size }) {
